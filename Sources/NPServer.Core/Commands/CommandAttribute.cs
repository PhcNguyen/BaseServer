...
public sealed class CommandAttribute(Common.Models.Command command, Common.Models.Authoritys requiredRole)
    : System.Attribute
{
    /// <summary>
    ...
    /// </summary>
    public Common.Models.Authoritys RequiredRole { get; } = requiredRole;
}