...
{
    /// <summary>
    /// Khởi tạo một phiên bản <see cref="ConfigContainer"/> từ <see cref="IniFileHelper"/> được cung cấp bằng cách sử dụng reflection.
    /// </summary>
    /// <param name="configFile">Tệp cấu hình ini được sử dụng để khởi tạo.</param>
    internal void Initialize(IniFileHelper configFile)
    {
