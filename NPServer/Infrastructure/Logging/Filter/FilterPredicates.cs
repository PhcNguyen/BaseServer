...
public static class FilterPredicates
{
    ...
    public static bool ByLevelHigher(NPLogLevel logMessLevel, NPLogLevel filterLevel) =>
    ...
    public static bool ByLevelLower(NPLogLevel logMessLevel, NPLogLevel filterLevel) =>
        (int)logMessLevel <= (int)filterLevel;
    ...
    public static bool ByLevelExactly(NPLogLevel logMessLevel, NPLogLevel filterLevel) =>
        (int)logMessLevel == (int)filterLevel;
}