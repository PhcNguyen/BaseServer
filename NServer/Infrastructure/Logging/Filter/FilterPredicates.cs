...
public static class FilterPredicates
{
    ...
    public static bool ByLevelHigher(NLogLevel logMessLevel, NLogLevel filterLevel) =>
    ...
    public static bool ByLevelLower(NLogLevel logMessLevel, NLogLevel filterLevel) =>
        (int)logMessLevel <= (int)filterLevel;
    ...
    public static bool ByLevelExactly(NLogLevel logMessLevel, NLogLevel filterLevel) =>
        (int)logMessLevel == (int)filterLevel;
}