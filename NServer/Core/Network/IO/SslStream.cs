...
namespace NServer.Core.Network.IO
{
    ...
    public static class SslStream
    {
        ...
        public static async ValueTask<Stream> EstablishSecureClientStreamAsync(TcpClient tcpClient)
        {
        ...
        /// <returns>Trả về một <see cref="Stream"/> được mã hóa SSL.</returns>
        public static async ValueTask<Stream> EstablishSecureClientStreamAsync(Socket socket)
        {
